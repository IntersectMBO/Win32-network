{-# LINE 1 "src\\System\\Win32\\Async\\IOData.hsc" #-}
{-# LANGUAGE DataKinds           #-}
...
iodOverlappedPtr AsyncSing    = ((\hsc_ptr -> hsc_ptr `plusPtr` 0))
{-# LINE 170 "src\\System\\Win32\\Async\\IOData.hsc" #-}
iodOverlappedPtr WsaAsyncSing = ((\hsc_ptr -> hsc_ptr `plusPtr` 0))
{-# LINE 171 "src\\System\\Win32\\Async\\IOData.hsc" #-}
...
iodDataPtr AsyncSing    = ((\hsc_ptr -> hsc_ptr `plusPtr` 32))
{-# LINE 179 "src\\System\\Win32\\Async\\IOData.hsc" #-}
iodDataPtr WsaAsyncSing = ((\hsc_ptr -> hsc_ptr `plusPtr` 32))
{-# LINE 180 "src\\System\\Win32\\Async\\IOData.hsc" #-}
...
instance Storable (IOData Async) where
    sizeOf    _ = (40)
{-# LINE 187 "src\\System\\Win32\\Async\\IOData.hsc" #-}
    alignment _ = (8)
{-# LINE 188 "src\\System\\Win32\\Async\\IOData.hsc" #-}

    poke buf IOData {iodOverlapped = ovl, iodData} = do
      ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) buf ovl
{-# LINE 191 "src\\System\\Win32\\Async\\IOData.hsc" #-}
      ((\hsc_ptr -> pokeByteOff hsc_ptr 32))       buf iodData
{-# LINE 192 "src\\System\\Win32\\Async\\IOData.hsc" #-}

    peek buf = do
      ovl     <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) buf
{-# LINE 195 "src\\System\\Win32\\Async\\IOData.hsc" #-}
      iodData <- ((\hsc_ptr -> peekByteOff hsc_ptr 32))       buf
{-# LINE 196 "src\\System\\Win32\\Async\\IOData.hsc" #-}
...
instance Storable (IOData WsaAsync) where
    sizeOf    _ = (40)
{-# LINE 202 "src\\System\\Win32\\Async\\IOData.hsc" #-}
    alignment _ = (8)
{-# LINE 203 "src\\System\\Win32\\Async\\IOData.hsc" #-}

    poke buf IOData {iodOverlapped = ovl, iodData} = do
      ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) buf ovl
{-# LINE 206 "src\\System\\Win32\\Async\\IOData.hsc" #-}
      ((\hsc_ptr -> pokeByteOff hsc_ptr 32))       buf iodData
{-# LINE 207 "src\\System\\Win32\\Async\\IOData.hsc" #-}

    peek buf = do
      ovl     <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) buf
{-# LINE 210 "src\\System\\Win32\\Async\\IOData.hsc" #-}
      iodData <- ((\hsc_ptr -> peekByteOff hsc_ptr 32))       buf
{-# LINE 211 "src\\System\\Win32\\Async\\IOData.hsc" #-}
      return $ IOData { iodOverlapped = ovl
                      , iodData
                      }
